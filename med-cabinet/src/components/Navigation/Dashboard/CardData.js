...
const CardData ={
    ...
    "flavors": ['Blueberry'],
    'availableFeatures':['Effects',' ', 'Medical', ' ', 'Negatives'],
    'attributes':['Happy',' ', 'Relaxed',' ', 'Euphoric',' ', 
    'Uplifted',' ', 'Creative', ' ', 'Stress', ' ', 'Depression', 
    ' ', 'Pain', ' ', 'Headaches',' ', 'Fatigue',' ', 'Dry Mouth', 
    ' ', 'Dry Eyes', ' ',  'Anxious',' ', 'Dizzy',' ', 'Paranoid'], 
    'ranks':['100', '94', '84', '77', '65', '100', '90', '71', '39', 
    '39', '100', '49', '25', '24', '23'],
